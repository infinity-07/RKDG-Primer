...
\begin{example}[Rayleigh-Taylor instability]
    https://www.sciencedirect.com/science/article/pii/S0021999104004760
\end{example}
The initial condition is [70]
\begin{equation}
    (\rho, u, v, p)=\left\{\begin{array}{ll}
        (2,0,-0.025 c \cos (8 \pi x), 1+2 y),   & \text { if } 0 \leq y<1 / 2,      \\
        (1,0,-0.025 c \cos (8 \pi x), y+3 / 2), & \text { if } 1 / 2 \leq y \leq 1,
    \end{array}\right.
\end{equation}
...
\lstinputlisting[language=C++, caption=My C++ Code]{模板/三阶TVD格式/main.cpp}
